export const data = [
    {
      name: "1: When talking to a customer or coworker...",
      answers: {
    ...
    {
      name: "2: If I have an important decision to make...",
      answers: {
        a: "I think it through completely before deciding",
        b: "I go with my gut instincts",
        c: "I consider the impact it will have on others before deciding",
    ...
    {
      name: "3: My office or work area mostly has...",
      answers: {
        a: "Family photos and sentimental items displayed",
        b: "Inspirational artwork, awards and posters displayed",
    ...
    {
      name: "4: If I am having a conflict with a co-worker or customer...",
      answers: {
    ...
    {
      name: "5: When I talk on the phone at work...",
      answers: {
    ...
    {
      name: "6: If a co-worker is upset...",
      answers: {
        a: "I ask if I can do anything to help",
        b: "I leave them alone because I don't want to intrude on their privacy",
        c: "I try to cheer them up and help them to see the bright side",
    ...
    {
      name: "7: When I attend meetings at work...",
      answers: {
    ...
    {
      name: "8: When I make a presentation in front of a group...",
      answers: {
    ...
    {
      name: "9: When a customer is explaining a problem to me...",
      answers: {
        a: "I try to understand and empathise with how they are feeling",
    ...
    {
      name: "10: When I attend training programs or presentations...",
      answers: {
    ...
    {
      name: "11: When I want to get my point across to customers or co-workers...",
      answers: {
    ...
    {
      name: "12: When I am late for a meeting or appointment...",
      answers: {
    ...
    {
      name: "13: I set goals and objectives at work that...",
      answers: {
    ...
    {
      name: "14: When explaining a problem to a co-worker whom I need help from...",
      answers: {
    ...
    {
      name: "15: If customers or co-workers are late for a meeting with me in my office...",
      answers: {
    ...
    {
      name: "16: When I am behind on a project and feel pressure to get it done...",
      answers: {
    ...
    {
      name: "17: When I feel verbally attacked by a customer or a co-worker...",
      answers: {
    ...
    {
      name: "18: When I see a co-worker or customer whom I like and haven't seen recently...",
      answers: {
        a: "I give them a friendly hug",
        b: "I greet them but don't shake their hand.",
